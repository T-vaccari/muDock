...
pdbqt_torsion_branch parse_branch_tree(const std::vector<std::string>& lines, std::size_t& pos, const std::uint32_t from, const std::uint32_t to,
                              std::vector<pdbqt_torsion_branch_node>& storage, std::vector<pdbqt_rotor>& rotors,
